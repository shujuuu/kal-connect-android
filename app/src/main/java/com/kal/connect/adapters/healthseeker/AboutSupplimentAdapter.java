...
public class AboutSupplimentAdapter extends RecyclerView.Adapter<AboutSupplimentAdapter.ViewHolder> {

    Context mContext;
    ArrayList<AboutSupplimentModel> mediModels;


    public AboutSupplimentAdapter(Context context, ArrayList<AboutSupplimentModel> mediModels) {
    ...
    @Override
    public AboutSupplimentAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_describe_medication, parent, false);
        return new AboutSupplimentAdapter.ViewHolder(itemView);

    }

    @Override
    public void onBindViewHolder(AboutSupplimentAdapter.ViewHolder holder, int position) {
        holder.mediName.setText(mediModels.get(position).getName());
        holder.startedIn.setText(mediModels.get(position).getDateString());
        holder.dosage.setText(mediModels.get(position).getDosage());
        holder.prescribedBy.setText(mediModels.get(position).getGivenBy());
        ...
        holder.mediName.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mediModels.get(position).setName(s+"");
            }
        ...
        holder.startedIn.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mediModels.get(position).setFromDate(s+"");
        ...
        holder.prescribedBy.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mediModels.get(position).setGivenBy(s+"");
            }
