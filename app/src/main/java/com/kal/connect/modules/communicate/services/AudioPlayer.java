...
public class AudioPlayer {
    ...
    public void playRingtone(Context mContext) {
        if (isPlaying()) {
            return;
        }
        if (mPlayer == null) {
            ...
            case AudioManager.RINGER_MODE_NORMAL:
                try {
                    ...
                    if (defaultRintoneUri == null) {
                        ...
                        mPlayer.setDataSource(mContext, defaultRintoneUri);
                    }
                    mPlayer.prepare();
...
//    }
    ...
    private static AudioTrack createProgressTone(Context context) throws IOException {
        AssetFileDescriptor fd = context.getResources().openRawResourceFd(R.raw.default_ringtone);
